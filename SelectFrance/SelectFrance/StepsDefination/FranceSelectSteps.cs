...
using SelectFrance.Logger;
using System;
using System.Threading;
using TechTalk.SpecFlow;

namespace SelectFrance.StepsDefination
{
    [Binding]
    public class SelectFranceSteps:Containers
    {
        
        
            public static ILog Logger = GenerateLogs.GetLogger(typeof(SelectFranceSteps));
            ...
            public void WhenISelectTheProvidedAndClickOnTheNextButton(string _region)
            {
                ...
                if (_countryRegion.Equals("france"))
                {
                    Logger.Info("Selected region as France");
                    BrowserConfigs.webDriver.FindElement(By.XPath(Containers._Francecountry)).Click();
                    Thread.Sleep(4000);
                }
