...
namespace SelectFrance.Bindings
{
    [Binding]
    public sealed class StepsHooks
    {
        ...
        public static void FetchTestResult()
        {
            ...
            {
                SelectFranceSteps.Logger.Info("No error occured.");
            }
            else if (ScenarioContext.Current.TestError != null)
            {
                if (stepType == "Given")
                {
                    ...
                    SelectFranceSteps.Logger.Error(ScenarioContext.Current.TestError.Message);
                    if (takesScreenshot != null)
                    {
                        SelectFranceSteps.Logger.Info("Exception occured.......Taking screenshots");
        ...
        public void WriteStatus()
        {
            if (ScenarioContext.Current.TestError == null)
            {
                ...
                SelectFranceSteps.Logger.Info("No Exception occured.......Dumping result to the Result Excel File");
            }
            else if (ScenarioContext.Current.TestError != null)
            {
                ...
                WriteDataToExcel.ExcelCode(res, msg, rowCount);
                SelectFranceSteps.Logger.Info("Exception occured " + "Status= " + res + " Exception is " + msg + ".......Dumping result to the Result Excel File");
            }
        ...
        {
            SelectFranceSteps.Logger.Info("Closing the Browser Instance........");
            ...
            SelectFranceSteps.Logger.Info("Killing chromedriver process........");
            SelectFranceSteps.Logger.Info("Successfully sent the Test Result File in email........");
            SelectFranceSteps.Logger.Info("Successfully sent the Log File in email........");
