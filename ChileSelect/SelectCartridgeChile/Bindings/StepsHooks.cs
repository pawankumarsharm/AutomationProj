...
namespace SelectCartridgeChile.Bindings
{
    [Binding]
    public sealed class StepsHooks
    {
        ...
        public static void FetchTestResult()
        {
            ...
            {
                ChileSelectSteps.Logger.Info("No error occured.");
            }
            else if (ScenarioContext.Current.TestError != null)
            {
                if (stepType == "Given")
                {
                    ...
                    ChileSelectSteps.Logger.Error(ScenarioContext.Current.TestError.Message);
                    if (takesScreenshot != null)
                    {
                        ChileSelectSteps.Logger.Info("Exception occured.......Taking screenshots");
        ...
        public void WriteStatus()
        {
            if (ScenarioContext.Current.TestError == null)
            {
                ...
                ChileSelectSteps.Logger.Info("No Exception occured.......Dumping result to the Result Excel File");
            }
            else if (ScenarioContext.Current.TestError != null)
            {
                ...
                WriteDataToExcel.ExcelCode(res, msg, rowCount);
                ChileSelectSteps.Logger.Info("Exception occured " + "Status= " + res + " Exception is " + msg + ".......Dumping result to the Result Excel File");
            }
        ...
        {
            ChileSelectSteps.Logger.Info("Closing the Browser Instance........");
            ...
            ChileSelectSteps.Logger.Info("Killing chromedriver process........");
            ChileSelectSteps.Logger.Info("Successfully sent the Test Result File in email........");
            ChileSelectSteps.Logger.Info("Successfully sent the Log File in email........");
            ...
            //TriggerMail.SendReportinMail();
            // TriggerMail2.SendMail();
        }
    }
}
