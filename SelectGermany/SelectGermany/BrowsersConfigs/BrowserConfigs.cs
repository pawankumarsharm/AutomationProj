...
namespace SelectGermany.BrowsersConfigs
{
    class BrowserConfigs:Containers
    {
        ...
        public static void Init()
        {
            ...
            else
            {
                ...
                {
                    case "Chrome":
                        GermanySelectSteps.Logger.Info("Checking for the available browsers in the configuration file........Chrome...OK");
                        webDriver = new ChromeDriver();
                        webDriver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(8);
                        break;
                    case "IE":
                        GermanySelectSteps.Logger.Info("Checking for the available browsers in the configuration file........Internet Explorer...OK");
                        webDriver = new InternetExplorerDriver();
                        webDriver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(15);
                        break;
                    case "Firefox":
                        GermanySelectSteps.Logger.Info("Checking for the available browsers in the configuration file........FireFox...OK");
                ...
                GermanySelectSteps.Logger.Info("Maximizing the browser instance");
        ...
        {
            GermanySelectSteps.Logger.Info("Redirecting to the url..." + url);
            //Thread.Sleep(2000);
            webDriver.Url = url;
            // Accept the cookies
        ...
        {
            webDriver.Quit();
            GermanySelectSteps.Logger.Info("Successfully closed the browser instance....");
