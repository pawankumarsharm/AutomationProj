...
namespace SelectGermany.Helpers
{
    ...
    {
        protected static string _Germanycountry = "//div[text()='Germany - Deutch']";
        ...
        protected static string _oxygenDefiency = "//button[contains(text(),'Nein')]";
        protected static string _casSearch = "//input[@id='search']";
        protected static string _contaminantChckBox = "//label[@class='inputBox-label']";
        protected static string _firstYes = "(//label[@class='radioGroup-item-label' and text()='Ja'])[1]";
        protected static string _secondYes = "(//label[@class='radioGroup-item-label' and text()='Ja'])[2]";
        protected static string _thirdYes = "(//label[@class='radioGroup-item-label' and text()='是的'])[3]";
        protected static string _firstNo = "(//label[@class='radioGroup-item-label' and text()='Nein'])[1]";
        protected static string _secondNo = "(//label[@class='radioGroup-item-label' and text()='Nein'])[2]";
        protected static string _thirdNo = "(//label[@class='radioGroup-item-label' and text()='不是'])[3]";
        protected static string _resetBtn = "//button[contains(text(),'Zurücksetzen')]";
        protected static string _doneBtn = "//button[contains(text(),'Fertig')]";
        ...
        protected static string txtResuable = "//label[text()='Reusable']";           //"//label[contains(text(),'可更换式')]";
        protected static string txtParp = "//label[text()='PAPR']";               //"//label[contains(text(),'动力送风过滤式呼吸器（PAPR)')]";
        protected static string txtDisposable = "//label[text()='Disposable']";    //"//label[contains(text(),'随弃式')]";
